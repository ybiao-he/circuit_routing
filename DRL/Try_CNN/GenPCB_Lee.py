...
# The parameters to be considered includes Grid size, #Obstacle, #Nets 
import numpy as np
import random
    ...
    def get_pin_from_chip(self, chip_pair_idx, chips_around_wrap):
        ...
        for ard_seg1_idx in range(len(chip_ards_fir)):
            ...
            for ard_seg2_idx in range(len(chip_ards_sec)):
                ...
                try:
                    field = Field(len=self.height, start=pin1, finish=pin2, barriers=tem_barriers)
                    field.emit()

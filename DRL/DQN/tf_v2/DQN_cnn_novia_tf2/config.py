...
UPDATE_Q = 1                   # Number of actions between gradient descent steps

INPUT_SHAPE = (30, 30)            # Size of the preprocessed input frame. With the current model architecture, anything below ~80 won't work.
